...
//画空心矩形函数
//sx,sy,ex,ey 矩形对顶角坐标,左上对右下
//width 线宽  color 线的颜色

void LCD_Draw_HollowRect(u16 sx,u16 sy,u16 ex,u16 ey,u16 width,u16 color)
{

		LCD_Fill(sx,sy,ex,sy+width,color);  //矩形顶部线
    LCD_Fill(sx,sy,sx+width,ey,color);  //矩形左侧线
    LCD_Fill(sx,ey-width,ex,ey,color);  //矩形底部线	
    LCD_Fill(ex-width,sy,ex,ey,color);  //矩形右侧线			
